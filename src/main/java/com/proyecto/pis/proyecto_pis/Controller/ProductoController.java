...
public class ProductoController {
    ...
    // Obtener estadísticas de productos (para futuras funcionalidades)
    ...
    public java.util.Map<String, Object> obtenerEstadisticas() {
        ...
        estadisticas.put("productosComida", productoRepository.findByTipo("comida").size());
        estadisticas.put("productosBebida", productoRepository.findByTipo("bebida").size());
        estadisticas.put("productosFrappes", productoRepository.findByTipo("frappes").size());
        return estadisticas;
    }
